...
# point on curve to act as generator point
Gx = 5
Gy = 4
...
print(testCurve.is_point_on_curve(Gx, Gy))

point = testCurve.multiple(1, G)
print(point)
point = testCurve.multiple(2, G)
print(point)
point = testCurve.multiple(3, G)
print(point)
point = testCurve.multiple(4, G)
print(point)
point = testCurve.multiple(5, G)
print(point)
point = testCurve.multiple(6, G)
print(point)
point = testCurve.multiple(7, G)
print(point)


for i in range(1, p+1):
	print('[{num}] Point after {num} additions: {pnt}'.format(num=i,pnt=testCurve.multiple(i, G)))
